...
public class Authenticator
{
    ...
    public Authenticator()
    {
        try
        {
            string s = "Host=localhost;Username=postgres;Password=" + filecontent + ";Database=passwords";
    ...
    {
        Console.WriteLine("Please enter if you want to login ('l') or Register ('r')");
    ...
    public bool register(string username, string password)
    {
        ...
        {
            Console.WriteLine("Password is too weak or contains username");
            return false;
        }
